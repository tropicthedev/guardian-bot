    ...
    return (
        <main className="w-full h-screen flex flex-col items-center justify-center px-4">
            <div className="max-w-sm w-full text-gray-600">
                ...
                <a href='/auth/login' className="w-full flex items-center justify-center gap-x-3 py-2.5 mt-5 border rounded-lg text-lg text-white font-medium hover:bg-gray-50 hover:text-black duration-150 active:bg-gray-100"
                >
